...
public class FavoritesActivity extends AppCompatActivity {
    ...
    boolean [] restaurants = new boolean [7];
    RecyclerView recyclerView;
    FavoritesAdapter adapter;
    ArrayList<String> items;
    boolean [] typeOfFood = new boolean [9];
    float [] rating = new float[7];
    float RATING = (float) 5.0;
    public float [] dist = new float [7];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent startIntent1 = new Intent(FavoritesActivity.this, SeeRestaurantList.class );
